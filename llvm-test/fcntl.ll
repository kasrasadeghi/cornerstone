...
@.str = private unnamed_addr constant [8 x i8] c"fcntl.c\00", align 1

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @open_file() local_unnamed_addr #0 {
  %1 = tail call i32 (i8*, i32, ...) @open(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 0) #3
  %2 = tail call i64 @lseek(i32 %1, i64 0, i32 2) #3
  %3 = tail call i8* @mmap(i8* null, i64 %2, i32 1, i32 2, i32 %1, i64 0) #3
  ret void
}
...
; Function Attrs: nounwind
declare i8* @mmap(i8*, i64, i32, i32, i32, i64) local_unnamed_addr #2
